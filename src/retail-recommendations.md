## Retail Expansion Analysis with Lasso and Ridge Regressions [[view code]](retail-recommendations.ipynb) 
...
**The code is available [here](retail-recommendations.ipynb) or by clicking on the [view code] link above.**
